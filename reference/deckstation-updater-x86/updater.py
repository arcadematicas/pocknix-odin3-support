...
import os, sys, subprocess, requests, threading, traceback, shutil, re
...
EXTERNAL_REPOS_FALLBACK = {
    ...
    'retroarch': ('static', 'https://buildbot.libretro.com/nightly/linux/x86_64/RetroArch.7z'),
}
        ...
        if repo_type != "static":
            try:
                ...
                for asset in data.get("assets", []):
                    ...
                    if "x86_64" in asset_name or "amd64" in asset_name:
                        score += 5
                    if "linux" in asset_name.lower():
                        score += 3
                    if "qt" in asset_name.lower():
                        score += 2
                    if "enhanced" in asset_name.lower():
                        score += 1
